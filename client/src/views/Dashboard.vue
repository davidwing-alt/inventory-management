            ...
            <div class="order-health-container">
              ...
              <div class="order-health-chart">
                ...
                <div class="donut-legend-compact">
                  <div class="legend-item-compact"><span class="legend-dot dot-delivered"></span>{{ t('status.delivered') }}</div>
                  <div class="legend-item-compact"><span class="legend-dot dot-shipped"></span>{{ t('status.shipped') }}</div>
                  <div class="legend-item-compact"><span class="legend-dot dot-processing"></span>{{ t('status.processing') }}</div>
                  <div class="legend-item-compact"><span class="legend-dot dot-backordered"></span>{{ t('status.backordered') }}</div>
                </div>
              </div>
            ...
            <table>
              ...
              <tbody>
                ...
                >
                  ...
                  <td @click="showBacklogDetail(item)" style="cursor: pointer;">
                    <span class="days-delayed" :class="item.days_delayed > 7 ? 'delay-critical' : 'delay-warning'">
...
.h-bar {
  ...
  border-radius: var(--radius-sm);
  transition: width 0.6s ease;
  /* floor the width so low-value categories stay wide enough to show their label */
  min-width: 64px;
}
